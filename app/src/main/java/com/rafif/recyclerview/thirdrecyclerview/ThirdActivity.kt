package com.rafif.recyclerview.thirdrecyclerview
...
import com.rafif.recyclerview.databinding.ActivityThirdBinding
...
class ThirdActivity : AppCompatActivity() {
    ...
    fun getListPahlawan(){
        try {
            ...
            Toast.makeText(this, "Upsss gabisa", Toast.LENGTH_SHORT).show()
        }
    }
}